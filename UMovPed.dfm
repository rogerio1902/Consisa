object FrmPed: TFrmPed
  ...
  object DBtxtNroPed: TDBText
    Left = 93
    Top = 8
    Width = 65
    Height = 17
    Color = clActiveBorder
    DataField = 'CDSVendaNroPed'
  ...
  object DBGrdVnd: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'CDSItensVendaProd'
        Width = 283
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'CDSItensVendaQtde'
      ...
      item
        Expanded = False
        FieldName = 'CDSItensVendaTotalAnt'
        Visible = False
      end>
  end
